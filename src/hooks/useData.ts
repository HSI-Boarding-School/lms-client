...
const mockCourses: Course[] = [
  ...
  },
  {
    ...
    description: 'Comprehensive introduction to data analysis and machine learning',
...
const mockAnalytics: Analytics = {
  ...
  totalRevenue: 284750,
  monthlyGrowth: 12.5,
  userGrowth: [1200, 1890, 2380, 3490, 4200, 5100, 6200, 7100, 8200, 9500, 10800, 12847],
  courseCompletions: [45, 67, 89, 123, 156, 189, 234, 267, 301, 389, 445, 498],
  revenueData: [15000, 23000, 31000, 42000, 51000, 63000, 78000, 89000, 105000, 128000, 156000, 184000]
};
